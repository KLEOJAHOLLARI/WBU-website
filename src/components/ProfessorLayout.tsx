...
import {
  ...
  UserCheck, Menu, ScrollText, ArrowLeft, CalendarDays, IdCard, Star, ClipboardCheck, Armchair, Clock, RefreshCw, MessagesSquare,
} from "lucide-react";
...
const navGroups = [
  {
    ...
    items: [
      ...
      { to: "/professor/discussions", label: "Discussions", icon: MessagesSquare },
      { to: "/professor/seating", label: "Seating", icon: Armchair },
      { to: "/professor/office-hours", label: "Office Hours", icon: Clock },
    ],
  },
  {
    label: "Academic",
    items: [
      ...
      { to: "/professor/resits", label: "Resit Exams", icon: RefreshCw },
      { to: "/professor/announcements", label: "Announcements", icon: Megaphone },
      { to: "/professor/performance", label: "My Performance", icon: Star },
    ],
  },
  {
    label: "Settings",
