...
import {
  ...
  CalendarDays, BookOpen, UserCircle, Menu, ScrollText, ArrowLeft, ClipboardList, CreditCard, Calculator, ClipboardEdit, IdCard, History, Bell, RefreshCw, Star, ClipboardCheck, Armchair, Clock, Briefcase, MessagesSquare,
} from "lucide-react";
...
const buildNavGroups = (registrationOpen: boolean): Array<{
  label: string;
  items: Array<{ to: string; label: string; icon: any; badge?: boolean; statusIcon?: any }>;
}> => [
  {
    label: "Main",
    items: [
      ...
      { to: "/portal/discussions", label: "Discussions", icon: MessagesSquare },
      ...
      ...(registrationOpen
        ? [
            { to: "/portal/registration", label: "Course Registration", icon: ClipboardEdit, statusIcon: Clock },
